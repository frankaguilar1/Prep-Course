...
case "green": return "This is green"; case "orange": return "This is orange"}
...
function esPrimo(numero) {
  ...
  for(var x = 2; x < numero; x++) if(numero % x === 0) return false;
  return true;
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var array = [];
  for(var x = 0; x < 11; x++) array.push(6 * x);
  return array;
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var x = numero + "";
  if(x.length === 3) return true; else;
  return false;
}
...
function doWhile(numero) {
  ...
  var a = 1
  do{ numero = numero + 5; a = a + 1} while(a < 9);
  return numero;
}
